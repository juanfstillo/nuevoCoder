    ...
    <div class="container">
        ...
        <form action="">
            <div class="row">
                ...
                <div class="col-9">
                    <input class="form-control" type="text" id="name" placeholder="Name Product" v-model="product.title"/>
                </div>
            </div>
            <!-- <div class="row">
                <div class="col-3">
            ...
            <div class="row">
                ...
                <div class="col-9">
                    <input class="form-control" type="number" id="stock" v-model="product.amount">
                </div>
            </div>
            <div>
